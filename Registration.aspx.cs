...
public partial class Registration : System.Web.UI.Page
{
    ...
    //Validation is checked in this function
    ...
    //The function helps in registering the user details in database
    ...
    private void SendMail()
    {
        ...
        Msg.From = new MailAddress("varshinibachawala@gmail.com");
        ...
        smtp.Host = "varshinibachawala@gmail.com";
        smtp.Port = 587;
        smtp.Credentials = new System.Net.NetworkCredential("varshinibachawala@gmail.com", "enfield1537");
        smtp.EnableSsl = true;
        smtp.Send(Msg);
    }
